...
## Description
Extract company business details from Yahoo Finance, include key executives, sector, industry, and financial metrics, and process company profile data into standardized format.
